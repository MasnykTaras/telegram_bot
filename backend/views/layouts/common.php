...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <?php echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        'label'        => Yii::t('backend', 'Currency'),
                        'url'    => ['/currency/index'],
                        'icon'   => '<i class="fa fa-thumb-tack"></i>',
                        'active' => (Yii::$app->controller->id == 'currency'),
                    ],
        [
                        'label'        => Yii::t('backend', 'Direction'),
                        'url'    => ['/direction/index'],
            'icon'         => '<i class="fa fa-thumb-tack"></i>',
                        'active'       => (Yii::$app->controller->id == 'direction'),
                    ],
                    [
                        'label'        => Yii::t('backend', 'Order'),
                        'url'          => ['/order/index'],
                        'badge'        => \common\models\Order::getNewCount(),
                        'badgeBgClass' => 'bg-yellow order-processed-count',
                        'icon'         => '<i class="fa fa-thumb-tack"></i>',
            ...
            'url'          => ['/card/index'],
            'badge'        => \common\models\Card::getNewCount(),
            'badgeBgClass' => 'bg-yellow order-processed-count',
            'icon'         => '<i class="fa fa-thumb-tack"></i>',
            ...
            'url'          => ['/email/index'],
            'badge'        => \common\models\Email::getNewCount(),
            'badgeBgClass' => 'bg-yellow order-processed-count',
            'icon'         => '<i class="fa fa-thumb-tack"></i>',
            'active'       => (Yii::$app->controller->id == 'email'),
        ],
        [
            'label'   => Yii::t('backend', 'Управление доступом'),
            'url'     => '#',
            'icon'    => '<i class="fa fa-flag"></i>',
            'options' => ['class' => 'treeview'],
            'active'  => in_array(Yii::$app->controller->module->id, ['admin']) && !(Yii::$app->controller->module->id == 'admin' && Yii::$app->controller->id == 'assignment' && Yii::$app->controller->action->id == 'view'),
            'items'   => [
                ['label' => Yii::t('backend', 'Black List'), 'url' => ['/black-list/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                ['label' => Yii::t('backend', 'IP Whitelist'), 'url' => ['/whitelist/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
            ],
        ],
        [
            'label'   => Yii::t('backend', 'Telegram Bot'),
            'options' => ['class' => 'header'],
        ],
        [
            'label'  => Yii::t('backend', 'Telegram Users'),
            'url'    => ['/telegram-bot-user/index'],
            'icon'   => '<i class="fa fa-thumb-tack"></i>',
            'active' => Yii::$app->controller->id === 'telegram-bot-user',
        ],
        [
        ...
        [
            'label' => Yii::t('backend', 'Manager DB'),
            'url'   => ['/managerDb/manager-db/index'],
            'icon'  => '<i class="fa fa-flag"></i>',
            'items' => [
                ['label' => Yii::t('backend', 'Export'), 'url' => ['/managerDb/manager-db/export'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                ['label' => Yii::t('backend', 'Import'), 'url' => ['/managerDb/manager-db/import'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
            ]
        ],
        ['label'   => Yii::t('statistic', 'Statistic'),
            'options' => ['class' => 'treeview site-header-area'],
            'url'     => '#',
            'icon'    => '<i class="fa fa-archive"></i>',
            'items'   => [
                [
                    'label' => Yii::t('statistic', 'Monthly Profit History'),
                    'url'   => ['/statistic/creating-statistic/index'],
                    'icon'  => '<i class="fa fa-thumb-tack"></i>',
                ],
